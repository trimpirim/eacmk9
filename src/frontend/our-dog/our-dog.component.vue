      ...
      <div class="row d-flex f-wrap">
        ...
        <div class="col-xs-12 col-sm-6 d-flex f-direction-column info-row-separator" v-if="dog.images.length > 0">
          <div class="info-content info-content-without-header">
            <img class="img-responsive center-block" :src="'/images/display?image=' + dog.images[0].content._id" width="500" height="auto" style="height: 300px; display: block; margin: 0 auto; padding: 10px;"/>
            <div class="row">
              <div class="col-xs-3" v-for="image in dog.images">
                <img class="img-responsive img-pup" :src="'/images/display?image=' + image.content._id">
              </div>
            </div>
          </div>
        </div>
