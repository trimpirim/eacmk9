                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12 visible-xs visible-sm">
                                        <button class="btn btn-primary btn-rounded-transparent u-full-width"
                                                type="button" data-toggle="collapse" data-target="#filter">
                                            Toggle filter
                                        </button>
                                    </div>
                                </div>
                                <div id="filter" class="collapse filter-content">
                                    <div class="row filter-content-list">
                                        <div class="col-xs-12 col-sm-3"
                                             v-for="(searchableObject, key) in searchableObjects"
                                             v-if="searchableObject.items.length > 0">
                                            <div class="dropdown-search">
                                                <button class="btn btn-primary btn-rounded-transparent dropdown-toggle"
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="javascript:void(0);"
                                                           v-on:click="changeFilter(key, null)">
                                                            {{ searchableObject.title }}
                                                        </a>
                                                    </li>
                                                    <template v-for="itemOrGroup in searchableObject.items">
                                                        <template v-if="itemOrGroup.group">
                                                            <li class="dropdown-header">
                                                                {{ itemOrGroup.title }}
                                                            </li>
                                                            <li v-for="item in itemOrGroup.items">
                                                                <a href="javascript:void(0);"
                                                                   v-on:click="changeFilter(key, item.value)">
                                                                    {{ item.title }}
                                                                </a>
                                                            </li>
                                                        ...
                                                        <template v-else>
                                                            <li>
                                                                <a href="javascript:void(0);"
                                                                   v-on:click="changeFilter(key, itemOrGroup.value)">
                                                                    {{ itemOrGroup.title }}
                                                                </a>
                                                            </li>
                                                        </template>
                            ...
                            <div class="col-xs-12">
                                <div class="dog-list">
                                    <ul class="dog-name" v-for="dog in dogs">
                                        <li>
                                            <router-link :to="{name: 'our-dog', params: {dog: dog._id}}">{{ dog.name
                                                }}
                                            </router-link>
                                        </li>
                                    </ul>
